...
| 范围 | 内容 |
|------|------|
| **In Scope** | 数据仪表盘 / 客服工作台 / 待办事项 / 会话记录（含离线待处理留言态） / 客户信息 / 会话转接 / 评价管理 / 知识文档 / 话术库 / FAQ / 会话规则 + 自动回复（12 个模块，12 个原型页 + 客户信息页不在侧边栏导航） |
...
| 11 | 会话规则 | admin-settings.html | ✅ 已有原型 | V1 | 评审点4 |

| 12 | **自动回复** | **admin-auto-reply.html** | ✅ 已有原型 | V1 | — |
...
| UC编号 | 用例名称 | 角色 | 说明 |
|--------|----------|------|------|
| UC-W-01 | 会话列表 Tab 切换 | R-A | 点「进行中/等待中/挂起/已结束」Tab 过滤 |
...
| 结束 | 客服关闭/超时 | status=close/ended_at | 推评价邀请；归档 |
