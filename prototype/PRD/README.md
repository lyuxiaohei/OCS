...
│   └── research/                      # 竞品分析等输入文档
├── 客服工单/
│   ├── PRD-客服工单-V0.8.md           # 当前版本(2026-09-01:开发评审修订+移除催办/回复用户)
│   ├── PRD-客服工单-V0.8.html         # 可独立发布的阅读版(单文件,内联 mermaid;python md2html.py 重跑生成)
...
| 客服工单 | [V0.8](客服工单/PRD-客服工单-V0.8.md) | ✅ 评审稿(2026-09-01:开发评审修订+移除催办/回复用户) | 后台 V0.9 |
| 客服工作台 | — | ⬜ 待建 | 后台 V0.9 |
...
| 版本 | 文件 | 说明 |
|------|------|------|
| V0.8 | `客服工单/PRD-客服工单-V0.8.md` | 当前版本，2026-09-01：开发评审(十八轮)修订 + 移除催办/回复用户(列表操作拆平、remind API/事件删除、超时链路保留) |
| V0.7 | `客服工单/archive/PRD-客服工单-V0.7.md` | 开发评审(十八轮)修订稿：联系方式手动维护/发起售后不带字段/供应链SKU命名/操作日志与历史版本不做等 |
