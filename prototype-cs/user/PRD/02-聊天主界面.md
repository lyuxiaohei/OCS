...
flowchart TD
    ...
    E --> F[插入系统消息: 人工客服已接入，您现在可以与真人客服沟通]
    F --> G[发送人工客服问候语: 客服王小明]
...
flowchart TD
    ...
    B --> C[插入系统消息: 本次会话已结束 · 如有需要请重新发起咨询]
    C --> D[客服发送道别语: 感谢您的咨询，欢迎下次再来～]
...
|----------|---------|--------|----------|------|
| 系统消息 | `.msg-system` | 系统 | 灰底白字居中 | 场景接入、会话状态变更 |
| 超时提醒 | `.msg-system.timeout-notice` | 系统 | 橙底橙字+边框 | 超时倒计时提醒 |
| 关闭通知 | `.msg-system.closed-notice` | 系统 | 灰底灰字+边框 | 会话已关闭 |
| 系统消息+操作 | `.msg-system-with-action` | 系统 | 灰底白字+操作按钮 | 带"去留言 >"操作入口 |
...
| `viewFaq` | FAQ 问题条目点击 | FAQ 卡片(faq) | `help.html` | 猜你想问列表，每条 FAQ 点击跳转帮助中心 |
