...
> **⚠️ 已归档（V0.2 时代文档，2026-07-23 归档）**：本文基于 V0.2（SLA 时效 + 5 态状态机 + 详情抽屉嵌工作台 + 配置写在 admin-settings.html），与现行版本全面不符，仅作历史参考，勿据此开发。现行版本见 `../PRD-客服工单-V0.5.md`（完成期限代替 SLA / 3 态状态机 / 建单·详情独立页 / 工单设置独立页）。
>
